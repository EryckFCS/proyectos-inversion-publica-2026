...
def stress_test_blindaje():
    root = Path(
        "/home/erick-fcs/Documentos/universidad/07_Ciclo/septimo_ciclo/public_investment_projects/scratch/mock_project"
    )
    ...
    if engine.catalog == {}:
        print(
            "✅ ÉXITO: El motor interceptó el YAML corrupto y devolvió un catálogo vacío de forma segura."
        )
    else:
                ...
                "files": [
                    {
                        "id": "D01",
                        "path": "test_data.csv",
                        "sha256": "819077227d853eade7ac21021469e71ed3d82a174092b67f276632c02821a711",
                    }
                ]
            }
        }
    ...
    if sidecar_alert:
        print(
            "✅ ÉXITO: El sistema detectó la inconsistencia entre el archivo físico y su sidecar de Pydantic."
        )
    else:
    ...
    if not success and "STDERR" in output:
        print(
            "✅ ÉXITO: El orquestador capturó la salida de error del subproceso para el reporte JSON."
        )
